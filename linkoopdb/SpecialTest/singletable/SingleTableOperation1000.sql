--µ¥±í²Ù×÷
--case±àÐ´ÈË ÍõìÏ
--±àÐ´ÈÕÆÚ 5ÔÂ7ÈÕ~5ÔÂ10ÈÕ
--ÒÔÏÂ²âÊÔÓÃÀý½ö°üº¬¶Ôpallas±íµÄ²Ù×÷£¨¹ØÓÚhdfs±íÌæ»»±íÃû¼°±í½á¹¹¼´¿É¸´ÓÃ£©
--Ä¿Ç°¶Ô½á¹ûµÄ²éÑ¯½ö°üº¬select·½Ê½£¬insert intoµ½½á¹û±íÖÐµÄ²âÊÔÓÃÀýºóÐø»áÌí¼Ó£¨ÒòÎª´´½¨½á¹û±íÖÐµÄ×Ö¶Î±È½Ï¸´ÔÓ£© 
...
----smallintÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þµÄ×Ó²éÑ¯
...
----integerÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000
WHERE TINTEGER >= 503040 OR TINTEGER <= 1223 LIMIT 10;

----integerÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þµÄ×Ó²éÑ¯
SELECT a.TSMALLINT,a.TINTEGER,a.TBIGINT,a.TREAL,a.TDOUBLE,a.TFLOAT,a.TDECIMAL,a.TNUMERIC,a.TDATE,a.TTIMESTAMP,a.TBOOL,a.TCHAR,a.TVARCHAR FROM P1000 AS a 
...
----numericÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þµÄ×Ó²éÑ¯
SELECT a.TSMALLINT,a.TINTEGER,a.TBIGINT,a.TREAL,a.TDOUBLE,a.TFLOAT,a.TDECIMAL,a.TNUMERIC,a.TDATE,a.TTIMESTAMP,a.TBOOL,a.TCHAR,a.TVARCHAR FROM P1000 AS a 
...
----smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varcharÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þµÄ×Ó²éÑ¯
...
----smallintÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓsmallintÁÐ
...
----smallintÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----integerÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓintegerÁÐ
...
----integerÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----bigintÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓbigintÁÐ
...
----bigintÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ         
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----realÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓrealÁÐ
...
----realÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ        
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----doubleÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓdoubleÁÐ
...
----doubleÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----floatÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓfloatÁÐ
...
----floatÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----decimalÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓdecimalÁÐ
...
----decimalÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----numericÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓnumericÁÐ
...
----numericÀàÐÍ×Ö¶Î¼ÓÊýÖµÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE 
...
----dateÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓdateÁÐ
...
----dateÀàÐÍ×Ö¶Î¼ÓÊ±¼äÀàÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE
...
----timestampÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓtimestampÁÐ
...
----timestampÀàÐÍ×Ö¶Î¼ÓÊ±¼äÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE
...
----boolean,Î´ÕÒµ½Ïà¹Øº¯Êý

----charÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓcharÁÐ
...
----charÀàÐÍ×Ö¶Î¼Ó×Ö¶ÎÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE
...
----varcharÀàÐÍ×Ö¶Î×÷Îª¹ýÂËÌõ¼þ£¬²éÑ¯ÊýÖµÐÍº¯Êý¼ÓvarcharÁÐ
...
----varcharÀàÐÍ×Ö¶Î¼Ó×Ö·ûÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ       
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR FROM P1000 WHERE
...
----ÊýÖµÐÍº¯Êý£¬×Ö·ûÐÍº¯Êý£¬Ê±¼äÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ
...
----smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varcharÀàÐÍ×Ö¶Î,ÊýÖµÐÍº¯Êý£¬×Ö·ûÐÍº¯Êý£¬Ê±¼äÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ
SELECT DISTINCT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),
...
----smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varcharÀàÐÍ×Ö¶Î,ÊýÖµÐÍº¯Êý£¬×Ö·ûÐÍº¯Êý£¬Ê±¼äÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þµÄ×Ó²éÑ¯
--±¨´í£¬Worker execution: ldb worker caused error: Null-aware predicate sub-queries cannot be used in nested conditions
SELECT DISTINCT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),
...
----smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varcharÀàÐÍ×÷Îªgroup byÌõ¼þ
...
----smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varcharÀàÐÍ×Ö¶Î,ÊýÖµÐÍº¯Êý£¬×Ö·ûÐÍº¯Êý£¬Ê±¼äÐÍº¯Êý×÷Îª¹ýÂËÌõ¼þ¡£ 
----smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar×÷Îªgroup byÌõ¼þ
...
--HAVING Ìõ¼þÇî¾Ù£¬Éæ¼°µ½µÄ¾ÛºÏº¯ÊýÓÐSUM£¬AVG£¬MAX£¬MIN£¬APPROX_COUNT_DISTINCT£¬APPROX_PERCENTILE£¬COVAR_POP£¬COVAR_SAMP£¬PERCENTILE_APPROX

----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬sumº¯Êý×÷ÎªhavingÌõ¼þ
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬avgº¯Êý×÷ÎªhavingÌõ¼þ
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬maxº¯Êý×÷ÎªhavingÌõ¼þ
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
--º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬minº¯Êý×÷ÎªhavingÌõ¼þ
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬approx_count_distinctº¯Êý×÷ÎªhavingÌõ¼þ
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬approx_percentileº¯Êý×÷ÎªhavingÌõ¼þ
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬covar_sampº¯Êý×÷ÎªhavingÌõ¼þ
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬covar_popº¯Êý×÷ÎªhavingÌõ¼þ  
SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
...
----º¯Êý¼ÓÊýÖµÐÍ×Ö¶Î¼Ó×Ó²éÑ¯×÷Îª¹ýÂËÌõ¼þ£¬smallint,integer,bigint,real,double,float,decimal,numeric,date,timestamp,boolean,char,varchar,unique×÷Îªgroup byÌõ¼þ£¬percentile_approxº¯Êý×÷ÎªhavingÌõ¼þ 
 SELECT DISTINCT TUNIQUE,TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TTIMESTAMP,TBOOL,TCHAR,TVARCHAR,CHARACTER_LENGTH(TVARCHAR),TRIM(TVARCHAR),
       TRIM(BOTH 'D' FROM TVARCHAR),TRIM(TRAILING 'g' FROM TVARCHAR),SUBSTRING(TVARCHAR FROM 13 FOR 40),LPAD(TVARCHAR,55,TVARCHAR),MD5(TVARCHAR),
       PRINTF(TVARCHAR+'%d %s',3232,TVARCHAR),REPLACE(TVARCHAR,'i','LDB'),REVERSE(TVARCHAR),TRIM(RIGHT(TVARCHAR,4)),DATE_FORMAT(TTIMESTAMP,'yyyy-MM-dd HH24:mi:ss'),
       DATE_TRUNC(TTIMESTAMP,'YEAR'),DAY(TTIMESTAMP),FROM_UTC_TIMESTAMP(TTIMESTAMP,'ASia/Seoul'),MINUTE(TTIMESTAMP),MONTH(TTIMESTAMP),SECOND(TTIMESTAMP),
