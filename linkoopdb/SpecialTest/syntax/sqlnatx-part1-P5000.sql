...
(
	SELECT 
		...
		UPPER(TCHAR||TCHARIDX1),LOWER(TCHAR||TCHARIDX1),
		UPPER(TVARCHARIDX1),LOWER(TVARCHARIDX1)
	FROM (SELECT * FROM P5000 LIMIT 10000)
)
WITH DATA;
SELECT COUNT(*) FROM SHI_TEST_QUERY;
SELECT * FROM SHI_TEST_QUERY ORDER BY TUNIQUE LIMIT 3;
...
(
	SELECT 	* 
	FROM 	(SELECT * FROM P5000 LIMIT 10000)  E 
	WHERE EXISTS 
		(
			SELECT * 
			FROM 	(SELECT * FROM P5000 LIMIT 10000)  D 
			WHERE 	D.TBIGINT  = E.TBIGINT 
		)
)
WITH DATA;
...
(
	...
	WHERE 	TSMALLINT IN 
		(
			SELECT TSMALLINT FROM P5000 ORDER BY TSMALLINT LIMIT 30000
		)
)
WITH DATA;
SELECT COUNT(*) FROM SHI_TEST_QUERY;
...
(
	...
	WHERE 	TSMALLINT IN 
		(
			SELECT TSMALLINT FROM (SELECT * FROM P5000 LIMIT 10000) ORDER BY TSMALLINT LIMIT 30000
		)
)
WITH DATA;
SELECT COUNT(*) FROM SHI_TEST_QUERY;
