...
FROM P1000 GROUP BY TSMALLINT, TINTEGER,TBIGINT
...
-- 2种字符型数据类型组合
SELECT TCHAR,TVARCHAR FROM P1000 GROUP BY TCHAR, TVARCHAR ORDER BY TCHAR,TVARCHAR LIMIT 10;
...
-- 查看返回结果
SELECT * FROM T_TYPE_CHARS ORDER BY TCHAR,TVARCHAR LIMIT 10;
...
-- 整型，小数型，字符型，日期型4种数据类型组合
SELECT TBIGINT,TDOUBLE,TCHAR,TDATE FROM P1000 GROUP BY TBIGINT, TDOUBLE, TCHAR,TDATE ORDER BY TBIGINT,TDOUBLE,TCHAR LIMIT 10;
...
-- 整型，小数型2种数据类型组合
SELECT TSMALLINT,TREAL FROM P1000 GROUP BY TSMALLINT, TREAL ORDER BY TSMALLINT,TREAL LIMIT 10;
...
-- 查看返回结果
SELECT * FROM T_TYPE_ARRAY21 ORDER BY TSMALLINT,TREAL LIMIT 10;

-- 整型，字符型2种数据类型组合
SELECT TINTEGER,TVARCHAR FROM P1000 GROUP BY TINTEGER, TVARCHAR ORDER BY TINTEGER,TVARCHAR LIMIT 10;
...
-- 整型，日期型2种数据类型组合
SELECT TBIGINT,TDATE FROM P1000 GROUP BY TBIGINT, TDATE ORDER BY TBIGINT,TDATE LIMIT 10;
...
-- 查看返回结果
SELECT * FROM T_TYPE_ARRAY23 ORDER BY TBIGINT,TDATE LIMIT 10;

-- 整型，小数型，字符型3种数据类型组合
SELECT TSMALLINT,TREAL,TCHAR FROM P1000 GROUP BY TSMALLINT, TREAL, TCHAR ORDER BY TSMALLINT,TREAL,TCHAR LIMIT 10;
...
-- 小数型，字符型，日期型3种数据类型组合
SELECT TREAL,TCHAR,TDATE FROM P1000 GROUP BY TREAL,TCHAR, TDATE ORDER BY TDATE,TCHAR LIMIT 10;
...
-- 查看返回结果
SELECT * FROM T_TYPE_ARRAY33 ORDER BY TDATE,TCHAR LIMIT 10;

-- 因为布尔型的数据在数据库表里只有一种数据：True，timestamp类型的数据在数据库表里没有重复数据，所以选取余下的11种类型的数据进行组合查询
SELECT TSMALLINT,TINTEGER,TBIGINT,TREAL,TDOUBLE,TFLOAT,TDECIMAL,TNUMERIC,TDATE,TCHAR,TVARCHAR FROM P1000
