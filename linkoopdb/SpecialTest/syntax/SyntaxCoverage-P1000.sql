...
CREATE TABLE T_TYPE_BIGINT AS (SELECT TBIGINT FROM P1000 GROUP BY TBIGINT)  WITH DATA properties ('linkoopdb.pallas.shard_number':'256') engine pallas;
-- 查看返回结果
SELECT * FROM T_TYPE_BIGINT LIMIT 10;

show table properties T_TYPE_BIGINT;
