...
CREATE TABLE T_TYPE_DATES AS (SELECT TDATE,TTIMESTAMP FROM P1000 GROUP BY TDATE,TTIMESTAMP);
...
--SMALLINT类型可以转换为INTEGER，BIGINT，REAL，DOUBLE，FLOAT，DECIMAL,NUMERIC,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型会返回提示信息
...
--INTEGER类型可以转换为SMALLINT，BIGINT，REAL，DOUBLE，FLOAT，DECIMAL,NUMERIC,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型返回会提示信息
...
--BIGINT类型可以转换为SMALLINT，INTEGER，REAL，DOUBLE，FLOAT，DECIMAL,NUMERIC,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型会返回提示信息
...
--REAL类型可以转换为INTEGER，BIGINT，BIGINT，DOUBLE，FLOAT，DECIMAL,NUMERIC,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型会返回提示信息
...
--DOUBLE类型可以转换为INTEGER，BIGINT，BIGINT，REAL，FLOAT，DECIMAL,NUMERIC,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型会返回提示信息
...
--FLOAT类型可以转换为INTEGER，BIGINT，BIGINT，REAL，DOUBLE，DECIMAL,NUMERIC,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型会返回提示信息
...
--DECIMAL类型可以转换为INTEGER，BIGINT，BIGINT，REAL，DOUBLE，FLOAT,NUMERIC,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型会返回提示信息
...
--NUMERIC类型可以转换为INTEGER，BIGINT，BIGINT，REAL，DOUBLE，FLOAT,DECIMAL,VARCHAR,CHAR,BOOLEAN类型的数据，不支持的数据类型会返回提示信息
...
--DATE类型可以转换为TIMEATAMP,VARCHAR,CHAR类型的数据，不支持的数据类型会返回NULL或给出提示信息
...
--TIMESTAMP类型可以转换为DATE,VARCHAR,CHAR类型的数据，不支持的数据类型会返回NULL或给出提示信息
...
--BOOLEAN类型可以转换为CHAR,VARCHAR类型的数据，其他不支持的数据类型返回null
