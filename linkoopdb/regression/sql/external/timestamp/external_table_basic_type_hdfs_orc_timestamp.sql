...
-- 删除表
drop table if exists t_external_hdfs_orc_timestamp_001;
drop table if exists t_external_hdfs_orc_timestamp_002;

-- 测试varchar，date,timestamp,boolean以及''等异常值
CREATE EXTERNAL TABLE t_external_hdfs_orc_timestamp_001(
a1 timestamp,
a2 timestamp,
a3 timestamp,
a4 timestamp,
...
-- 测试varchar，date,timestamp,boolean以及''等异常值
CREATE EXTERNAL TABLE t_external_hdfs_orc_timestamp_002(
a1 timestamp,
a2 timestamp,
a3 timestamp,
a4 timestamp,
