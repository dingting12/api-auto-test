...
-- ldbdist external  csv 
-- 删除t_external_ldbdist_csv_varchar_001表
drop table if exists t_external_ldbdist_csv_varchar_001;
...
-- 删除t_external_ldbdist_csv_varchar_002表
drop table if exists t_external_ldbdist_csv_varchar_002;
...
drop table if exists t_external_ldbdist_csv_varchar_003;
...
select * from t_external_ldbdist_csv_varchar_003;


-- 删除t_external_ldbdist_csv_varchar_004表
drop table if exists t_external_ldbdist_csv_varchar_004;
...
select * from t_external_ldbdist_csv_varchar_004;


-- 删除t_external_ldbdist_csv_varchar_005表
drop table if exists t_external_ldbdist_csv_varchar_005;
...
select * from t_external_ldbdist_csv_varchar_005;



-- 删除t_external_ldbdist_csv_varchar_007表
drop table if exists t_external_ldbdist_csv_varchar_007;
...
-- 删除t_external_ldbdist_csv_varchar_008表
drop table if exists t_external_ldbdist_csv_varchar_008;
...
-- 删除t_external_ldbdist_csv_varchar_009表
drop table if exists t_external_ldbdist_csv_varchar_009;
...
select * from t_external_ldbdist_csv_varchar_009;


-- 删除t_external_ldbdist_csv_varchar_010表
drop table if exists t_external_ldbdist_csv_varchar_010;
...
select * from t_external_ldbdist_csv_varchar_010;

-- 删除t_external_ldbdist_csv_varchar_011表
drop table if exists t_external_ldbdist_csv_varchar_011;
...
select * from t_external_ldbdist_csv_varchar_011;

drop table if exists t_external_ldbdist_csv_varchar_012;
...
select * from t_external_ldbdist_csv_varchar_012;


-- 删除t_external_ldbdist_csv_varchar_013表
drop table if exists t_external_ldbdist_csv_varchar_013;
...
select * from t_external_ldbdist_csv_varchar_013;


-- 删除t_external_ldbdist_csv_varchar_015表
drop table if exists t_external_ldbdist_csv_varchar_015;
...
select * from t_external_ldbdist_csv_varchar_015;
 
 
-- 删除t_external_ldbdist_csv_varchar_016表
drop table if exists t_external_ldbdist_csv_varchar_016;
...
select * from t_external_ldbdist_csv_varchar_016;


-- 删除t_external_ldbdist_csv_varchar_017表
drop table if exists t_external_ldbdist_csv_varchar_017;
...
select * from t_external_ldbdist_csv_varchar_017;


-- 删除t_external_ldbdist_csv_varchar_018表
drop table if exists t_external_ldbdist_csv_varchar_018;
...
select * from t_external_ldbdist_csv_varchar_018;


-- 删除t_external_ldbdist_csv_varchar_019表
drop table if exists t_external_ldbdist_csv_varchar_019;
...
select * from t_external_ldbdist_csv_varchar_019;

-- 删除t_external_ldbdist_csv_varchar_020表
drop table if exists t_external_ldbdist_csv_varchar_020;
...
select * from t_external_ldbdist_csv_varchar_020;


-- 删除t_external_ldbdist_csv_varchar_021表
drop table if exists t_external_ldbdist_csv_varchar_021;
...
select * from t_external_ldbdist_csv_varchar_021;


-- 删除t_external_ldbdist_csv_varchar_022表
drop table if exists t_external_ldbdist_csv_varchar_022;
...
select * from t_external_ldbdist_csv_varchar_022;

-- 删除 t_external_ldbdist_csv_varchar_023 表
drop table if exists t_external_ldbdist_csv_varchar_023;
...
select * from t_external_ldbdist_csv_varchar_023;
