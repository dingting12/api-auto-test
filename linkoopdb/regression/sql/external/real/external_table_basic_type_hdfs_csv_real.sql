...
a1 double
)location('HDFSRPC_URL/real_001.csv')
...
a1 double 
)location('HDFSRPC_URL/real_002.csv')
format 'csv' (delimiter ',');
...
a1 double
)location('HDFSRPC_URL/real_006.csv')
format 'csv' (delimiter ',');
...
a1 double 
)location('HDFSRPC_URL/real_007.csv')
format 'csv' (delimiter ',');
...
a1 real
)location('HDFSRPC_URL/real_003.csv')
format 'csv' (delimiter ',');
...
a1 real   
)location('HDFSRPC_URL/real_004.csv')
format 'csv' (delimiter ',');
...
a1 real  
)location('HDFSRPC_URL/real_005.csv')
format 'csv' (delimiter ',');
