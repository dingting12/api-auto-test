...
a1 char(64001)
)location('HDFSRPC_URL/varchar_001.csv')
...
-- 创建表t_external_hdfs_csv_char_002，测试长度为10，数据大小为100000
create external table t_external_hdfs_csv_char_002(
a1 char(10) 
)location('HDFSRPC_URL/varchar_001.csv')
format 'csv' (delimiter ',');
  
--查询t_external_hdfs_csv_char_002的数据,实际返回10
...
a1 char(20)  
)location('HDFSRPC_URL/varchar_003.csv')
format 'csv' (delimiter ',');
...
a1 char(30) 
)location('HDFSRPC_URL/varchar_004.csv')
format 'csv' (delimiter ',');
...
a1 char(30)  
)location('HDFSRPC_URL/varchar_005.csv')
format 'csv' (delimiter ',');
...
-- 创建表t_external_hdfs_csv_char_007，测试varchar中文字符，值为你好
...
-- 创建表t_external_hdfs_csv_char_008，测试varchar中英文字符，值为你好asdf
...
a1 char(30)   
)location('HDFSRPC_URL/varchar_007.csv')
format 'csv' (delimiter ',');
  
--查询t_external_hdfs_csv_char_011的数据，实际返回为'123456789'
select * from t_external_hdfs_csv_char_011;

drop table if exists t_external_hdfs_csv_char_012;
-- 创建表t_external_hdfs_csv_char_012，测试date类型，时间为2020-05-08
...
-- 创建表t_external_hdfs_csv_char_013，测试timestamp类型,时间为2020-05-08 12:19:01
...
a1 char(30)   
)location('HDFSRPC_URL/varchar_008.csv')
format 'csv' (delimiter ',');
...
a1 char(30) 
)location('HDFSRPC_URL/varchar_009.csv')
format 'csv' (delimiter ',');
