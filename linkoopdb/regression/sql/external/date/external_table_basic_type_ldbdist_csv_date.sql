...
a1 date  
)location('LDBDIST_URL/csv/date_001.csv')
...
a1 date  
)location('LDBDIST_URL/csv/date_002.csv')
format 'csv' (delimiter ',');
...
a1 date  
)location('LDBDIST_URL/csv/date_003.csv')
format 'csv' (delimiter ',');
...
a1 date  
)location('LDBDIST_URL/csv/date_004.csv')
format 'csv' (delimiter ',');
...
a1 date  
)location('LDBDIST_URL/csv/date_005.csv')
format 'csv' (delimiter ',');
...
-- 创建表t_external_ldbdist_csv_date_012，测试超出date范围的timestamp类型，值为2020-01-01 01:01:01
create external table t_external_ldbdist_csv_date_012(
a1 date  
)location('LDBDIST_URL/csv/date_012.csv')
format 'csv' (delimiter ',');
...
a1 date  
)location('LDBDIST_URL/csv/date_019.csv')
format 'csv' (delimiter ',');
...
a1 date  
)location('LDBDIST_URL/csv/date_020.csv')
format 'csv' (delimiter ',');
