...
a1 boolean  
)location('HDFSRPC_URL/boolean_001.csv')
...
a1 boolean  
)location('HDFSRPC_URL/boolean_002.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_003.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_004.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_005.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_006.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_007.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_008.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_009.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_010.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_011.csv')
format 'csv' (delimiter ',');
...
a1 boolean  
)location('HDFSRPC_URL/boolean_012.csv')
format 'csv' (delimiter ',');
