...
-- 测试float边界值±1，有效位数
drop table if exists t_external_hdfs_orc_float_001;
drop table if exists t_external_hdfs_orc_float_002;

CREATE EXTERNAL TABLE t_external_hdfs_orc_float_001(
a1 float,
a2 float,
a3 float,
a4 float,
...
CREATE EXTERNAL TABLE t_external_hdfs_orc_float_002(
a1 float,
a2 float,
a3 float,
a4 float,
