...
a1 float
)location('HDFSRPC_URL/float_001.csv')
...
a1 float 
)location('HDFSRPC_URL/float_002.csv')
format 'csv' (delimiter ',');
...
a1 float 
)location('HDFSRPC_URL/float_006.csv')
format 'csv' (delimiter ',');
...
a1 float 
)location('HDFSRPC_URL/float_007.csv')
format 'csv' (delimiter ',');
...
a1 float
)location('HDFSRPC_URL/float_003.csv')
format 'csv' (delimiter ',');
...
a1 float   
)location('HDFSRPC_URL/float_004.csv')
format 'csv' (delimiter ',');
...
a1 float  
)location('HDFSRPC_URL/float_005.csv')
format 'csv' (delimiter ',');
