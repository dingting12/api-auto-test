--timestamp:时间戳类型，范围：1000-01-01 00:00:00/9999-12-31 23:59:59
...
--timestamp的最大值+1s
insert into T_TYPE_TIMESTAMP values(to_timestamp('10000-01-01 00:00:00','yyyy-mm-dd hh24:mi:ss'));  --null
--查询表T_TYPE_TIMESTAMP
select * from T_TYPE_TIMESTAMP;
...
--date:日期类型，默认格式:yyyy-mm-dd  范围 1000-01-01/9999-12-31
