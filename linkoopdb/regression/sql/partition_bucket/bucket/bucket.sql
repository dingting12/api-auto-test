...
LOCATION ('HDFSRPC_URL/partition_bucket') FORMAT 'csv' (DELIMITER ',') CLUSTERED BY (TINT) INTO 4 BUCKETS;
-- 查看创建表的ddl
...
SHOW CREATE TABLE T_BUC_PALLAS;
INSERT INTO T_BUC_PALLAS SELECT TINT, TDECIMAL, TVARCHAR FROM EX_PART_BUC;
SELECT * FROM T_BUC_PALLAS;
