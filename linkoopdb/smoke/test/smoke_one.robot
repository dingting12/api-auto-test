...
SCHEMATEST
    ...
    Compare Files        E051-01 SELECT DISTINCT.sql                                                                CORE_基本查询/E051-01 SELECT DISTINCT.ref
    Compare Files        E051-02 GROUP BY clause.sql                                                                CORE_基本查询/E051-02 GROUP BY clause.ref
    Compare Files        E051-04 GROUP BY can contain columns not in list.sql                                       CORE_基本查询/E051-04 GROUP BY can contain columns not in list.ref
    Compare Files        E051-05 Select list items can be renamed.sql                                               CORE_基本查询/E051-05 Select list items can be renamed.ref
    Compare Files        E051-06 HAVING clause.sql                                                                  CORE_基本查询/E051-06 HAVING clause.ref
    Compare Files        E051-07 Qualified all in select list.sql                                                   CORE_基本查询/E051-07 Qualified all in select list.ref
    Compare Files        E051-08 Correlation names in the FROM clause.sql                                           CORE_基本查询/E051-08 Correlation names in the FROM clause.ref
    Compare Files        E051-09 Rename columns in the FROM clause.sql                                              CORE_基本查询/E051-09 Rename columns in the FROM clause.ref
    Compare Files        E061-01 Comparison predicate.sql                                                           CORE_基本查询/E061-01 Comparison predicate.ref
    Compare Files        E061-02 BETWEEN predicate.sql                                                              CORE_基本查询/E061-02 BETWEEN predicate.ref
    Compare Files        E061-03 IN predicate with list of values.sql                                               CORE_基本查询/E061-03 IN predicate with list of values.ref
    Compare Files        E061-04 LIKE predicate.sql                                                                 CORE_基本查询/E061-04 LIKE predicate.ref
    Compare Files        E061-05 LIKE predicate ESCAPE clause.sql                                                   CORE_基本查询/E061-05 LIKE predicate ESCAPE clause.ref
    Compare Files        E061-06 NULL predicate.sql                                                                 CORE_基本查询/E061-06 NULL predicate.ref
    Compare Files        E061-07 Quantified comparison predicate.sql                                                CORE_基本查询/E061-07 Quantified comparison predicate.ref
    Compare Files        E061-08 EXISTS predicate.sql                                                               CORE_基本查询/E061-08 EXISTS predicate.ref
    Compare Files        E061-13 Correlated subqueries.sql                                                          CORE_基本查询/E061-13 Correlated subqueries.ref
    Compare Files        E061-14 Search condition.sql                                                               CORE_基本查询/E061-14 Search condition.ref
    Compare Files        E071-01 UNION DISTINCT table operator.sql                                                  CORE_基本查询/E071-01 UNION DISTINCT table operator.ref
    Compare Files        E071-02 UNION ALL table operator.sql                                                       CORE_基本查询/E071-02 UNION ALL table operator.ref
    Compare Files        E071-03 EXCEPT DISTINCT table operator.sql                                                 CORE_基本查询/E071-03 EXCEPT DISTINCT table operator.ref
    Compare Files        E071-05 Columns combined via table operators need not have exactly the same data type.sql  CORE_基本查询/E071-05 Columns combined via table operators need not have exactly the same data type.ref
    Compare Files        E071-06 Table operators in subqueries.sql                                                  CORE_基本查询/E071-06 Table operators in subqueries.ref
    Compare Files        LDBX107-03 Query with both system tables and user tables.sql                               CORE_基本查询/LDBX107-03 Query with both system tables and user tables.ref
    ...
    Compare Files   	 E011-04 Arithmetic operators.sql                                              CORE_数据类型/E011-04 Arithmetic operators.ref
    Compare Files   	 E011-05 Numeric comparison.sql                                                CORE_数据类型/E011-05 Numeric comparison.ref
    Compare Files   	 E011-06 Implicit casting among the numeric data types.sql                     CORE_数据类型/E011-06 Implicit casting among the numeric data types.ref
    Compare Files   	 E011_E021_F051.sql                                                            CORE_数据类型/E011_E021_F051.ref
    Compare Files   	 E021-03 Character literals.sql                                                CORE_数据类型/E021-03 Character literals.ref
    Compare Files   	 E021-function.sql                                                             CORE_数据类型/E021-function.ref
    Compare Files   	 E031-01-02-03.sql                                                             CORE_数据类型/E031-01-02-03.ref
    Compare Files   	 F051-01 DATE data type (including support of DATE literal).sql                CORE_数据类型/F051-01 DATE data type (including support of DATE literal).ref
    Compare Files   	 F051-03 TIMESTAMP data type.sql                                               CORE_数据类型/F051-03 TIMESTAMP data type.ref
    Compare Files   	 F051-04 Comparison predicate on DATE, TIME, and TIMESTAMP data types.sql      CORE_数据类型/F051-04 Comparison predicate on DATE, TIME, and TIMESTAMP data types.ref
    Compare Files   	 F051-05 Explicit CAST between datetime types and character string types.sql   CORE_数据类型/F051-05 Explicit CAST between datetime types and character string types.ref
    Compare Files   	 F051-06 CURRENT_DATE.sql                                                      CORE_数据类型/F051-06 CURRENT_DATE.ref
    Compare Files   	 F051-07-08 LOCALTIME_LOCALTIMESTAMP.sql                                       CORE_数据类型/F051-07-08 LOCALTIME_LOCALTIMESTAMP.ref
