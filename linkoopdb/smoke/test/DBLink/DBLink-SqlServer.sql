...
create database link SQLSERVER_LINK_001  connect to 'sa' identified by 'LinkoopDB123' using 'jdbc:sqlserver://192.168.1.72;Database=insen' properties ('schema':'dbo','caseSensitive':'false');

select * from SQLSERVER_LINK_001.t_datatype_sqlserver;
