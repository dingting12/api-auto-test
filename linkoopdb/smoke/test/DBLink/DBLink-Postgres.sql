...
create database link POSTGRES_LINK_001  connect to 'postgres' identified by '123456' using 'jdbc:postgresql://192.168.1.72:5432/postgres' properties ('caseSensitive':'false');

select * from POSTGRES_LINK_001.t_datatype_postgres;
